...
def main():
    ...
    lines.append(f"| Observer height | {config.OBSERVER_HEIGHT} m |")
    ...
    lines.append(f"| Tree height field | {config.TREES_HEIGHT_FIELD!r} (None = every tree uses observer height) |")
    ...
    lines.append(f"| Tile buffer | {config.TILE_BUFFER_PX} px ({config.TILE_BUFFER_PX * 0.5:.1f} m) |")
